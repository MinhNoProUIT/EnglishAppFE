...
const courses = [
  { id: '1', title: 'Friends Series', lesson: 3, advanced: 45, points: 100, days: 32, image: 'https://picsum.photos/200/300' },
  { id: '2', title: 'Practice in Holiday', lesson: 4, advanced: 76, points: 100, days: 56, image: "https://picsum.photos/200/150" },
  { id: '3', title: 'At the airport', lesson: 2, advanced: 54, points: 100, days: 46, image: 'https://picsum.photos/200/120' },
  { id: '4', title: 'Sports', lesson: 4, advanced: 87, points: 100, days: 28, image: 'https://picsum.photos/200/130' },
  { id: '5', title: 'Hang out with friends', lesson: 1, advanced: 76, points: 100, days: 23, image: 'https://picsum.photos/200/210' },
];
            ...
            <View style={styles.info}>
              ...
              <View style={styles.infoRow}>
                ...
                <View style={styles.detail}>
                  ...
                  <Text style={styles.detailText}>Advanced: {item.advanced}</Text>
                </View>
              </View>
              <ProgressBar
              ...
              <View style={styles.infoRow}>
                <View style={styles.detail}>
                  <Text style={styles.detailText}>points: {item.points} / 100</Text>
                </View>
                <View style={styles.detail}>
