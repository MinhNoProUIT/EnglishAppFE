...
const courses = [
    ...
    { id: '2', title: 'Sport', topic: 'People-lifestyle', isActive: 'true', level: 'A1 - A2', detail: 'Lorem Ipsum is simply dummy test of the prin...', image: "https://picsum.photos/200/150" },
    { id: '3', title: 'At the work', topic: 'Business', isActive: 'false', level: 'A1 - A2', detail: 'Lorem Ipsum is simply dummy test of the prin...', image: 'https://picsum.photos/200/120' },
                    ...
                    <View style={styles.card}>
                        <View style={styles.row}>
                            ...
                            {item.isActive == 'true' ?
                                ...
                                :
                                <TouchableOpacity style={[styles.button, { backgroundColor: '#FF8080', height: 58 }]}>
